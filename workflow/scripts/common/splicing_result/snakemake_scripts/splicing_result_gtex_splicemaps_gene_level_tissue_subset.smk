...
rule splicing_result_tissue_subset_gene_level_spliceai_splicemap:
    input:
    ...
    script:
        "../gene_level/gtex_tissue_subset/gene_spliceai_splicemap.py"
        
        
rule splicing_result_tissue_subset_gene_level_spliceai_splicemap_ref_psi:
    input:
...
rule splicing_result_tissue_subset_gene_level_mmsplice:
    input:
    ...
    script:
        "../gene_level/gtex_tissue_subset/gene_mmsplice_splicemap.py"
        
        
rule splicing_result_tissue_subset_gene_level_mmsplice_ref_psi:
    input:
        pred_mmsplice = OUTPUT_DIR_RAW + config_static['splicing_pred']['models']['mmsplice_splicemap']['gtex_splicemaps'],
        var_samples_df = OUTPUT_DIR_VCF_ANNO + config_static['vcf_annotation']['rare_vars']['qual_filtered'],
        gene_tpm = config_precomputed['gene_tpm_gtex'].format(gtex_version=config['gtex_version']),
    ...
    script:
        "../gene_level/gtex_tissue_subset/gene_mmsplice_splicemap_ref_psi.py"
        
              
rule splicing_result_tissue_subset_gene_level_mmsplice_cat:
    input:
    ...
    script:
        "../gene_level/gtex_tissue_subset/gene_mmsplice_splicemap_cat.py"
        
             
rule splicing_result_tissue_subset_gene_level_mmsplice_cat_all_cats:
    input:
...
rule splicing_result_tissue_subset_gene_level_absplice_dna:
    input:
    ...
    script:
        "../gene_level/gtex_tissue_subset/gene_absplice_dna.py"
               
            
rule splicing_result_tissue_subset_gene_level_absplice_rna:
    input:
    ...
    script:
        "../gene_level/gtex_tissue_subset/gene_absplice_rna.py"
        

rule splicing_result_tissue_subset_gene_level_absplice_rna_all_cats:
    input:
