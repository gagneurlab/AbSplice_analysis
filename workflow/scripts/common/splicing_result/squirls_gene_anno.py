...
# SQUIRLS
df_squirls = pd.read_csv(snakemake.input['squirls'])
...
df_squirls = df_squirls[['variant', 'gene_id', 'squirls_scores']]
df_squirls.to_csv(snakemake.output['squirls_anno'], index=False)